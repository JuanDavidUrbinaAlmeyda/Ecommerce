        ...
        <div class="card p-4 shadow">
            <form id="productForm">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="productDescription" rows="3" placeholder="Escribe una breve descripción" required></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="productPrice" placeholder="Ej. 199.99" step="0.01" min="0" required>
                </div>

                <!-- Imagen (URL) -->
                <div class="mb-3">
                    <label for="productImage" class="form-label">URL de la Imagen</label>
                    <input type="url" class="form-control" id="productImage" placeholder="Ej. https://imagen.com/foto.jpg" required>
                </div>
